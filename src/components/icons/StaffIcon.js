...
const StaffIcon = () => (
    <div className="sc-message--avatar-staff">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <g>
                <path className="background" fill="#F0F0FF" d="M12 0c6.627 0 12 5.373 12 12s-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0"/>
                <path className="hair" fill="#66F" d="M18.206 9.209c.08-.389.12-.784.12-1.181 0-2.847-2.066-5.274-4.876-5.73-2.811-.455-5.537 1.195-6.437 3.896C5.4 6.298 4.06 7.478 3.757 9.066c-.304 1.587.503 3.179 1.963 3.871.054 1.74 1.364 3.184 3.091 3.406 1.728.222 3.36-.843 3.853-2.513h.178c.797 1.05 2.111 1.572 3.412 1.353 1.3-.218 2.372-1.14 2.782-2.393.41-1.253.09-2.63-.83-3.575v-.006z"/>
                <path className="shirt" fill="#B3B3FF" d="M11.28 15.974c-3.213.002-6.135 1.861-7.496 4.772 4.226 3.97 10.688 4.351 15.351.903-1.122-3.386-4.288-5.673-7.855-5.675z"/>
